...
public interface UserCartDao {
    ...
    List<UserCart> cartList(@Param("nickname") String nickname, @Param("offset") Integer offset, @Param("limit") Integer limit);

    Integer cartCount(@Param("nickname") String nickname);
